...
**[`07-one-shots/`](documento/07-one-shots/) — aventuras fechadas**
- `TUNGUSKA-1908.md` - One-shot ambientada no Evento de Tunguska (1908)

**[`personagens/`](documento/personagens/) — fichas de personagens jogados**
- `ECHO.md` · `TIMOR.md` · `yelena.md` - Personagens da mesa Vanguarda Escarlate (ver [Agradecimentos](agradecimentos.html))
